...
namespace NLog.Targets
{
    public static class MessageFormatter
    {
        ...
        public static string GetMessageInner(bool useJSON, Layout layout, LogEventInfo info, IList<Field> fields, string routingKey)
        {
            return GetMessageInner(useJSON, false, layout, info, fields, routingKey);
        }

        public static string GetMessageInner(bool useJSON, bool useLayoutAsMessage, Layout layout, LogEventInfo info, IList<Field> fields, string routingKey)
        {
            if (!useJSON)
